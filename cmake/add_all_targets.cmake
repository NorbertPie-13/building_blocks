function(add_all_targets)
  ...
  set(oneValueArgs LIB_NAME EXE_NAME LIB_DESTINATION EXE_DESTINATION
                   PUBLIC_HEADER)
  ...
  add_so(${ARG_LIB_NAME} SOURCES ${ARG_LIB_SOURCES} INCLUDES
         ${ARG_LIB_INCLUDES})

  # Set public headers for the library (if provided)
  if(DEFINED ARG_PUBLIC_HEADER)
    set_target_properties(${ARG_LIB_NAME} PROPERTIES PUBLIC_HEADER
                                                     "${ARG_PUBLIC_HEADER}")
  endif()
