# Function to disable lint/clang-tidy warnings for specific files
# Usage:
# disable_warnings(
...
function(disable_warnings)
  ...
  foreach(file ${ARG_FILES})
    if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/${file}")
      ...
      set_source_files_properties(${file_absolute} PROPERTIES
        COMPILE_FLAGS "-w"                         # Disable all compiler warnings
  ...
  if(ARG_TARGET)
    if(TARGET ${ARG_TARGET})
      ...
      # Add the files to a source group to make it clear they have warnings disabled
      if(target_filtered_files)
        source_group("NoWarnings" FILES ${target_filtered_files})
        message(STATUS "Created 'NoWarnings' source group for target: ${ARG_TARGET}")
      endif()
    else()
